...
const FAQ = [
    ...
    },
    {
        ...
        answer:
        "Лица, имеющие среднее профессиональное образование сдают вступительные испытания на базе МАГУ в период с 16 по 25 июля.",
    },
    {
        question:
    ...
    },
    {
        ...
        answer:
        "Вы можете подать одно заявление на бюджет и одно на внебюджет, в которых будут включены 5 направления подготовки.",
    },
    {
        question: "Каким образом необходимо подавать документы в 2023 году?",
        answer:
        "Документы на поступление принимаются онлайн через Личный кабинет абитуриента на официальном сайте Мурманского государственного университета и через Cуперсервис \"Поступление в вуз онлайн\" посредством федеральной государственной информационной системы \"Единый портал государственных и муниципальных услуг (функций)\" (далее - ЕПГУ). В случае, если заявление заполнено корректно, Вам придет сообщение, что документы приняты в обработку или перезвонит технический секретарь."
        ,
    },
    {
        question:
